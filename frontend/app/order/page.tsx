...
export default function CheckoutPage() {
  ...
  */
  ...
  // Если нет товаров (редко, т.к. редирект)
  if (items.length === 0) {
  ...
  return (
    <div className="h-screen flex flex-col">
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside className="w-[30%] min-w-[250px] bg-white border-r border-gray-200 p-6 flex flex-col">
          <h1 className="text-4xl font-extrabold uppercase tracking-tight mb-8">
            Оформление<br />заказа
          </h1>
          <nav className="space-y-4 text-sm">
            <div className="flex items-center gap-2 text-gray-600 hover:text-black cursor-pointer" onClick={() => router.push("/")}>
              <Home className="w-4 h-4" />
              <span>Главная</span>
            </div>
            <div className="flex items-center gap-2 text-gray-600 hover:text-black cursor-pointer" onClick={() => router.push("/cart")}>
