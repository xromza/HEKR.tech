...
export default function Begin() {
  ...
  return (
    <header className='absolute bg-white w-full h-[20%] '>
      <div className='flex flex-row w-full h-[80%] items-end justify-around uppercase ml-[1%]'>
        <Image src="/logo.svg" width={96} height={69} alt="Логотип компании HEKR, состоящий из белых букв, написанных по часовой стрелке, на черном фоне " />
